# Don't Remove Credit Tg - @StarAJ0125
# Ask Doubt on telegram @StarAJ0125
...
OWNER_ID = 1116405290 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [1116405290]

AUTH_CHANNEL = -1002409813500
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/not_realX") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/xd_owns") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/xd_owns")                              
                ],           
            ]
      )
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/StarAJ` - Download and upload files (sudo)🎬\n\n"
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[StarAJ�](https://t.me/StarAJ0125)"
    if raw_text3 == '1':
        CR = '[StarAJ�](https://t.me/StarAJ0125)'
    elif raw_text3:
        try:
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            elif "https://transcoded-videos-v2.classx.co.in/videos/neetphysicskota-data/" in url:
                url = url.replace("https://transcoded-videos-v2.classx.co.in/videos/neetphysicskota-data/", "")
